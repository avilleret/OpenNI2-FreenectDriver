...
{
	// TODO rewrite this for libfreenect
...
{
	if (freenect_open_device(m_pDriver->m_freenectCtx, &m_freenectDev, 0 /* device id */ ) < 0) {
		m_driverServices.errorLoggerAppend("Could not open device\n");
